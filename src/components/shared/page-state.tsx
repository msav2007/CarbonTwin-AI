...
export function PageState({
  ...
  return (
    <div className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-[#08111B] px-4">
      ...
      >
        ...
        <h1 className="mt-4 font-display text-3xl font-bold text-[#F8FAFC]">
          {title}
        </h1>
